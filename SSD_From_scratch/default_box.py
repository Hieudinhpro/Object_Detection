...
cfg = {
    ...
    "input_size": 300, #SSD300 (size of image 300x300)
    "bbox_aspect_num": [4, 6, 6, 6, 4, 4], # Nhan tỷ lệ khung hình cho source1->source6` (idea of authors)
    "feature_maps": [38, 19, 10, 5, 3, 1], # 38x38, 19x19, 10x10, 5x5,
    "steps": [8, 16, 32, 64, 100, 300], # Size of default box , (init size of default bounding box)
    "min_size": [30, 60, 111, 162, 213, 264], # Size of default box (folowing thuc nghiem cua cac nguoi di truoc)
...
class DefBox():
    '''create 8732 Default Boxes in SSD folowing paper
        output : 8732 bound boxes with cx cy, h, w range 0 to 1'''
